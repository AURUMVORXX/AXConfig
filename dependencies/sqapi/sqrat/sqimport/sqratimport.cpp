...
static HSQAPI sqrat_newapi() {
    ...
    /*stdaux*/
    sq->printcallstack = sqstd_printcallstack;
    sq->throwerrorf = sqstd_throwerrorf;

    /*stdblob*/
    sq->createblob = sqstd_createblob;
    sq->getblob = sqstd_getblob;
    sq->getblobsize = sqstd_getblobsize;

    /*stdio*/
    sq->fopen = sqstd_fopen;
    sq->fread = sqstd_fread;
    sq->fwrite = sqstd_fwrite;
    sq->fseek = sqstd_fseek;
    sq->ftell = sqstd_ftell;
    sq->fflush = sqstd_fflush;
    sq->fclose = sqstd_fclose;
    sq->feof = sqstd_feof;
    sq->createfile = sqstd_createfile;
    sq->getfile = sqstd_getfile;
    sq->loadfile = sqstd_loadfile;
    sq->dofile = sqstd_dofile;
    sq->writeclosuretofile = sqstd_writeclosuretofile;

    /*stdstring*/
    sq->format = sqstd_format;
    sq->pushstringf = sqstd_pushstringf;
